    ...
    en: {
      ...
      about: {
        ...
        content: {
          ...
          differenceBody: 'We keep the team compact, communicate directly and deliver in iterative milestones. You always know what is done, what is next and why each decision was made.',
      ...
      services: {
        ...
        header: {
          ...
          description: 'We provide targeted digital services that improve execution speed and customer experience.'
        },
        cards: {
          webTitle: 'Web Development',
          webBody: 'High-performing websites and business platforms that stay maintainable after launch.',
          uxTitle: 'UI/UX Design',
          uxBody: 'Clear interfaces and interaction flows tailored to your users and business model.',
          interfacesTitle: 'Product Interfaces',
          interfacesBody: 'Cross-device design systems and front-end experiences with strong usability.',
          growthTitle: 'Growth Support',
          growthBody: 'SEO-ready structure, conversion-oriented pages and practical optimization loops.'
        },
        launches: {
          ...
          chiroBody: 'Clear information hub for parents, members and volunteers with practical pages for registration, activities and contact.',
          chiroLink: 'Visit chironegenmanneke.be'
        },
        cta: {
          title: 'Need a quote or roadmap for your project?',
          description: 'Share your goals and constraints. We answer with practical next steps.',
          button: 'Get in Touch'
        }
      },
      products: {
      ...
      contact: {
        ...
        instructions: {
          ...
          description: 'The clearer your brief, the faster we can estimate and propose the right plan.',
    ...
    fr: {
      ...
      about: {
        ...
        content: {
          ...
          differenceBody: 'Nous gardons une équipe compacte, communiquons directement et livrons par étapes itératives. Vous savez toujours ce qui est fait, ce qui vient ensuite et pourquoi chaque décision a été prise.',
          clarityTitle: 'Clarté avant tout',
          clarityBody: 'Aucune ambiguïté sur le périmètre, le planning ou les livrables.',
      ...
      services: {
        ...
        header: {
          ...
          description: "Nous proposons des services numériques ciblés qui accélèrent l'exécution et améliorent l'expérience client."
        },
        cards: {
          webTitle: 'Développement web',
          webBody: 'Des sites performants et des plateformes métier qui restent simples à maintenir après le lancement.',
          uxTitle: 'Design UI/UX',
          uxBody: 'Des interfaces claires et des parcours adaptés à vos utilisateurs et à votre modèle économique.',
          interfacesTitle: 'Interfaces produit',
          interfacesBody: "Des systèmes de design multi-supports et des expériences front-end à forte utilisabilité.",
          growthTitle: 'Accompagnement croissance',
          growthBody: 'Une structure prête pour le SEO, des pages orientées conversion et des boucles d’optimisation concrètes.'
        },
        launches: {
          ...
          chiroBody: 'Hub clair pour les parents, membres et bénévoles avec des pages pratiques pour les inscriptions, les activités et le contact.',
          chiroLink: 'Visiter chironegenmanneke.be'
        },
        cta: {
          title: "Besoin d'un devis ou d'une feuille de route pour votre projet ?",
          description: 'Partagez vos objectifs et vos contraintes. Nous revenons avec des prochaines étapes concrètes.',
      ...
      contact: {
        ...
        instructions: {
          ...
          description: 'Plus votre brief est clair, plus nous pouvons estimer rapidement et proposer le bon plan.',
        ...
        form: {
          ...
          validationName: 'Veuillez entrer un nom valide (au moins 2 caractères).',
    ...
    nl: {
      ...
      about: {
        ...
        content: {
          ...
          differenceBody: 'We houden het team compact, communiceren rechtstreeks en leveren in iteratieve mijlpalen. Je weet altijd wat er klaar is, wat hierna komt en waarom elke beslissing genomen werd.',
          ...
          craftBody: 'Een sterke visuele identiteit met praktische UX-beslissingen.',
          fitTitle: 'Gemaakt om mee te groeien',
          fitBody: 'Oplossingen die bruikbaar blijven terwijl je bedrijf groeit.',
      ...
      services: {
        ...
        header: {
          ...
          description: 'We leveren gerichte digitale diensten die de uitvoering versnellen en de klantervaring verbeteren.'
        },
        cards: {
          webTitle: 'Webontwikkeling',
          webBody: 'Sterke websites en bedrijfsplatformen die ook na lancering onderhoudbaar blijven.',
          uxTitle: 'UI/UX-design',
          uxBody: 'Duidelijke interfaces en interactieflows afgestemd op je gebruikers en je businessmodel.',
          interfacesTitle: 'Productinterfaces',
          interfacesBody: 'Cross-device designsystemen en front-end ervaringen met sterke gebruiksvriendelijkheid.',
          growthTitle: 'Groeiondersteuning',
          growthBody: 'SEO-klare structuur, conversiegerichte pagina’s en praktische optimalisatielussen.'
        },
        launches: {
          ...
          chiroBody: 'Duidelijke informatiehub voor ouders, leden en vrijwilligers met praktische pagina’s voor inschrijving, activiteiten en contact.',
          chiroLink: 'Bezoek chironegenmanneke.be'
        },
        cta: {
          title: 'Een offerte of roadmap nodig voor je project?',
          description: 'Deel je doelen en randvoorwaarden. Wij antwoorden met concrete volgende stappen.',
      ...
      contact: {
        ...
        instructions: {
          ...
          description: 'Hoe duidelijker je briefing, hoe sneller we kunnen inschatten en het juiste plan voorstellen.',
